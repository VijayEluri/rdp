...
public class KeyCode {
	...
	private static final String[] main_key_SG = { "§°", "1+|", "2\"@", "3*#",
			"4ç", "5%", "6&¬", "7/Š", "8(¢", "9)", "0=", "'?Ž", "^`~", "qQ",
			"wW", "eE", "rR", "tT", "zZ", "uU", "iI", "oO", "pP", "üè[", "š!]",
	...
	private static final String[] main_key_SF = { "§°", "1+|", "2\"@", "3*#",
			"4ç", "5%", "6&¬", "7/Š", "8(¢", "9)", "0=", "'?Ž", "^`~", "qQ",
			"wW", "eE", "rR", "tT", "zZ", "uU", "iI", "oO", "pP", "èü[", "š!]",
	...
	private static final String[] main_key_SE = { "§œ", "1!", "2\"@", "3#£",
			"4€$", "5%", "6&", "7/{", "8([", "9)]", "0=}", "+?\\", "Ž`", "qQ",
			"wW", "eE", "rR", "tT", "yY", "uU", "iI", "oO", "pP", "åÅ", "š^~",
			"aA", "sS", "dD", "fF", "gG", "hH", "jJ", "kK", "lL", "öÖ", "äÄ",
			"'*", "zZ", "xX", "cC", "vV", "bB", "nN", "mM", ",;", ".:", "-_",
	...
	private static final String[] main_key_CF = { "#|\\", "1!±", "2\"@", "3/£",
			"4$¢", "5%€", "6?¬", "7&Š", "8*²", "9(³", "0)Œ", "-_œ", "=+Ÿ",
			"qQ", "wW", "eE", "rR", "tT", "yY", "uU", "iI", "oO§", "pP¶",
			"^^[", "žš]", "aA", "sS", "dD", "fF", "gG", "hH", "jJ", "kK", "lL",
			";:~", "``{", "<>}", "zZ", "xX", "cC", "vV", "bB", "nN", "mM",
			",'-", ".", "éÉ", "«»°" };

	/** * Portuguese keyboard layout */
	private static final String[] main_key_PT = { "\\Š", "1!", "2\"@", "3#£",
			"4$§", "5%", "6&", "7/{", "8([", "9)]", "0=}", "'?", "«»", "qQ",
			"wW", "eE", "rR", "tT", "yY", "uU", "iI", "oO", "pP", "+*\\š",
			"\\'\\`", "aA", "sS", "dD", "fF", "gG", "hH", "jJ", "kK", "lL",
	...
	private static final String[] main_key_PL = { "`~", "1!", "2@", "3#", "4$",
			...
			"aA±¡", "sS¶Š", "dD", "fF", "gG", "hH", "jJ", "kK", "lL³£", ";:",
			"'\"", "\\|", "zZ¿¯", "xXŒ¬", "cCæÆ", "vV", "bB", "nNñÑ", "mM",
			",<", ".>", "/?", "<>|" };
	...
	private static final String[] main_key_HR_jelly = { "`~", "1!", "2@", "3#",
			...
			"'\"æÆ", "\\|Ÿ®", "zZ", "xX", "cC", "vV", "bB", "nN", "mM", ",<",
			".>", "/?", "<>|" };

	/** * Croatian keyboard layout ** */
	private static final String[] main_key_HR = { "žš", "1!", "2\"·", "3#^",
			"4$¢", "5%°", "6&²", "7/`", "8(ÿ", "9)Ž", "0=œ", "'?š", "+*ž",
			"qQ\\", "wW|", "eE", "rR", "tT", "zZ", "uU", "iI", "oO", "pP",
			"¹©÷", "ðÐ×", "aA", "sS", "dD", "fF[", "gG]", "hH", "jJ", "kK³",
			"lL£", "èÈ", "æÆß", "Ÿ®€", "yY", "xX", "cC", "vV@", "bB{", "nN}",
			"mM§", ",;", ".:", "-_/", "<>" };
